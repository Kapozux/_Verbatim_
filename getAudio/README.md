...
Full source is also concatenated into [`完整源代码_Verbatim.md`](完整源代码_Verbatim.md).
...
uppercase labels rather than emoji. All theming lives in CSS custom properties at the top of `style.css`.
